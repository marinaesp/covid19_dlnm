...
For vaccine data, I do the same, but since we do not have data from 2020 for vaccine, it will have 1162 (581*2) rows with missing data. But there are additional 17 missing data for 17 municipalities that did not have vaccination data in 2021 (see 01_data_preparation.Rmd file for the list of these municipalities).
