...
```{r}
formulas.sptemp.mult <-list(formula.sptemp.multmodel2, formula.sptemp.multmodel3, formula.sptemp.multmodel4)
labels.sptemp.mult <-c("sptemp.model.bc", "sptemp.model.bc_ozone", "sptemp.model.bc_ozone_pm10", "sptemp.model.bc_ozone_pm10_vaccine")
```
...
```{r}
table3 <- data.table::data.table(Model  = c("sptemp.bc_ozone", "sptemp.bc_ozone_pm10", "sptemp.bc_ozone_pm10_vaccine"),
                     DIC = NA,
                     logscore = NA)
